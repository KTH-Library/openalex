...
[`openalex_polite()`](https://kth-library.github.io/openalex/reference/openalex_polite.md)
to temporarily set or unset the email used in the user agent string when
making API requests:
